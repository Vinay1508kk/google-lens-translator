...
if uploaded_file is not None:
    ...
    if extracted_texts:
        ...
        try:
            ...
            st.download_button("⬇️ Download Extracted Text", combined_text, file_name="detected_text.txt")
            st.download_button("⬇️ Download Translated Text", translated, file_name=f"translated_{target_lang}.txt")
